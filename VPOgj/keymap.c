...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LGUI, KC_KP_0),MT(MOD_LALT, KC_KP_4),MT(MOD_LSFT, KC_KP_5),MT(MOD_LCTL, KC_KP_6),KC_NO,                  KC_NO,          QK_REPEAT_KEY,  CK_SELECT_WORD, CK_SENTENCE_CASE_TOGGLE, QK_CAPS_WORD_TOGGLE, KC_TRANSPARENT,
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          TO(6),          TO(7),          TO(8),          KC_NO,          KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 QK_LLCK,        KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_NO,          TO(8),          TO(7),          TO(6),          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_voyager(
    QK_GRAVE_ESCAPE, KC_1,           KC_2,           KC_3,           KC_4,           KC_5,                                           KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_BSPC,        
